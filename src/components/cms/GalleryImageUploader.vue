...
import { ref } from 'vue';
import { getFilesFromDrop, pickFiles, type ImageUploaderFile } from '@/lib/ImageUploader';
...
async function confirm() {
    ...
    for (const i of images.value) {
        await remote.post("gallery/createimage", { id: props.gallery.id!!, name: i.name }).then(async (res: { image: Resource }) => {
